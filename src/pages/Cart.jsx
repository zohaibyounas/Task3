      ...
      {state.length === 0 ? (
        ...
        <div className="flex justify-center font-light ">
          <div className="flex flex-col w-full px-6 sm:px-52 absolute bg-white">
            <div className="flex-1 py-1 px-6 sm:px-6 p-2">
              <Link to="/">
            ...
            <div className="flex justify-between text-base font-medium text-gray-900 bottom-0">
              <p>Subtotal</p>
            ...
            <div className="mt-3">
              <button
                ...
                className="flex items-center justify-center rounded-md border border-transparent bg-[#4ADE80] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-green-400"
              >
                Checkout
              </button>
            </div>
